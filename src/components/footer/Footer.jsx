...
export const Footer = () => {
  return (
    <div className='row mw footer'>
      <div className="col-lg-12 footer-children">
        <div className="row">
          <div className="col-lg-3 footer-icon-group">
            <Link to='/'>
              <img src={logo} alt="" />
            </Link>
            <div className="messangers-group">
              <a href='#' className="messangers-item">
                <div className="messenger-item-facebook">
              ...
              <a href='#' className="messangers-item">
                <div className="messenger-item-instagram">
              ...
              <a href='' className="messangers-item">
                <div className="messenger-item-telegram">
                  <svg width="20" height="20" viewBox="0 0 20 20"  xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col-lg-3 footer-navigation">
            <h4 className='footer-navigation-title'>Kares tili darslar</h4>
            <ul>
              <li><Link to='/'>Boshlang’ich daraja</Link></li>
              <li><Link to='/'>O’rta daraja</Link></li>
              <li><Link to='/'>Yuqori daraja</Link></li>
            </ul>
          </div>
          <div className="col-lg-3 footer-navigation">
            <h4 className='footer-navigation-title'>Topik darslar</h4>
            <ul>
              <li><Link to='/'>Topik I daraja</Link></li>
              <li><Link to='/'>Topik II daraja</Link></li>
              <li><Link to='/'>EPS - Topik daraja</Link></li>
            </ul>
          </div>
          <div className="col-lg-3 footer-navigation">
            <h4 className='footer-navigation-title'>Konsalting</h4>
            <ul>
